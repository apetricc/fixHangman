  ...
  local background = display.newImageRect("images/paper3.png", 1200, 1200)
...
function scene:destroy( event )
   ...
   display.remove(resetButton)
    for i=1,table.getn(newLetter),1 do
      display.remove(newLetter[i])
    end
    newLetter={}
    print("ran removal in hangman")
    -- Code here runs prior to the removal of scene's view
    composer.gotoScene( "chooseWord" )
    print("Got to removal")
